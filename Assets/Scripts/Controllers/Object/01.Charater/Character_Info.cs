...
public abstract partial class Character : Base
{
    ...
    protected PlayerAction m_strCharacterAction = new PlayerAction();
    ...
    public float Stamina { get { return m_tStatInfo.m_fStemina; } set { m_tStatInfo.m_fStemina = value; } }
    ...
    public float CrouchSpeed { get { return m_tStatInfo.m_fCrouchSpeed; } set { m_tStatInfo.m_fCrouchSpeed = value; } }
    #endregion
}
