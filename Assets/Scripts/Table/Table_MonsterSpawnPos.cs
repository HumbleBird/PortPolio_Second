...
public class Table_MonsterSpawnPos : Table_Base
{
    [Serializable] 
    public class Info
    {
        public int      m_nID;
        public int      m_iDungeonType;
        public int      m_iMonsterSpawnPosId;
    ...
    protected bool Read(CSVReader _reader, Info _info, int _nRow, int _nStartCol)
    {
        ...
        _reader.get(_nRow, ref _info.m_iDungeonType);
        _reader.get(_nRow, ref _info.m_iMonsterSpawnPosId);
        _reader.get(_nRow, ref _info.m_iMonsterId);
