...
public class Table_Dialogue : Table_Base
{
    [Serializable] 
    public class Info
    {
        public int    m_nID;
        public int    m_iNextIdx;
        public string m_iTextEnglish;
    }
    ...
    protected bool Read(CSVReader _reader, Info _info, int _nRow, int _nStartCol)
    {
        ...
        _reader.get(_nRow, ref _info.m_iNextIdx);
        _reader.get(_nRow, ref _info.m_iTextEnglish);
