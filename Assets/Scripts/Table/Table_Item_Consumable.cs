...
public class Table_Item_Consumable : Table_Base
{
    [Serializable] 
    public class Info
    {
    ...
    protected bool Read(CSVReader _reader, Info _info, int _nRow, int _nStartCol)
    {
        ...
        _reader.get(_nRow, ref _info.m_iConsumableType);
        _reader.get(_nRow, ref _info.m_iValue);
        _reader.get(_nRow, ref _info.m_iMaxCount);
